...
enum RunAction {
    ...
    ///
    /// The node is validated from the JOURNAL: `torii run list-paused` shows the question
    /// the human was actually asked, and an answer to a node that never asked is refused
