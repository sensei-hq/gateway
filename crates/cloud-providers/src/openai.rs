...
use kernel::types::io::{ImageRequest, ImageResponse, SttRequest, SttResponse, TtsResponse};
...
// OpenAI's ChatModel is a thin delegation to the shared OpenAI-compatible core (key
// check + delegate with the default model) — generated by the shared macro.
