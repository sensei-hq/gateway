...
use kernel::types::io::{SttRequest, SttResponse, TtsResponse};
...
// Grok's ChatModel is a thin delegation to the shared OpenAI-compatible core (key
// check + delegate with the default chat model) — generated by the shared macro.
crate::impl_openai_compat_chat!(GrokAdapter, model = DEFAULT_CHAT_MODEL, name = "grok");
