...
| [Expiration tracking](expiration-tracking.md) | Planned (SP-0 reactive `401→auth-lock`; stateful tracking → SP-DATA) | gateway + data-tier | proactive oauth/subscription/credits/free-tier-reset alerts |
