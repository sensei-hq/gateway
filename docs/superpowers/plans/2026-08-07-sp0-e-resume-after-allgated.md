...
- [ ] **Step 1:** Add engine tests named for the `quota-demote-to-tier.md` "additional" scenarios not yet covered by Tasks 3–5, asserting the observable behavior:
  ...
  - "All candidates terminal → resume_after None + human action, never pause forever" (Task 4). *(The gateway half still holds; the ORCHESTRATOR half was reversed 2026-09-04 — it now pauses indefinitely on a named human action.)*
